...
class _ProductScreenState extends State<ProductScreen> {
  ...
  final List<ToppingItem> _toppings = [
    ToppingItem(name: 'Tomato',  imagePath: 'assets/images/tomato.png',  price: 0.50),
    ToppingItem(name: 'Onions',  imagePath: 'assets/images/onion.png',   price: 0.30),
    ToppingItem(name: 'Pickles', imagePath: 'assets/images/cucumber.png',price: 0.30),
    ToppingItem(name: 'Bacons',  imagePath: 'assets/images/bacon.png',   price: 1.00),
  ];

  final List<ToppingItem> _sideOptions = [
    ToppingItem(name: 'Fries',    imagePath: 'assets/images/fries.png',     price: 2.50),
    ToppingItem(name: 'Coleslaw', imagePath: 'assets/images/colslow.png',   price: 1.50),
    ToppingItem(name: 'Salad',    imagePath: 'assets/images/lattes.png',    price: 1.20),
    ToppingItem(name: 'Onion',    imagePath: 'assets/images/onionrings.png',price: 1.80),
  ];
                  ...
                  children: [
                    ...
                    ItemsRow(
                      ...
                      onItemToggled: (index) => setState(
                          () => _toppings[index].selected = !_toppings[index].selected),
                    ),
                    ItemsRow(
                      title: 'Side options',
                      items: _sideOptions,
                      onItemToggled: (index) => setState(
                          () => _sideOptions[index].selected = !_sideOptions[index].selected),
                    ),
